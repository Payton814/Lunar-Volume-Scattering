...
def nDpm3(D, Shape = "Sphere", Distribution = "CE4"):
...
D = 0.03 ## Smallest rock diameter allowed to be sampled
Dmax = 2.0
Distribution = "CE4"
...
Depth = 20  ## The volume being filled will be a rectangular prism, this is the z-direction
Area = 10*10 ## Cross section of the prism
...
if (Shape != "Cuboid"): ## Cuboids are special so they need to be treated differently
    ...
    NRocks = quad(n_V_SVII, D, Dmax)[0]*Area*Depth
else:   
